...
void drawMesh(SceneObject sceneObj) {
	...
	//Part B
	// Since we need to use all three axes to rotate, we will use following:
...
void display(void) {
	...
	//Part A
    mat4 camRot = RotateX(camRotUpAndOverDeg) * RotateY(camRotSidewaysDeg);
    
    view = Translate(0.0, 0.0, -viewDist) * camRot;
...
// /////////////////////////////////////////////////////////////////////////
// PART C
static void adjustAmbient(vec2 mat) {
    sceneObjs[toolObj].ambient += mat[0];
    sceneObjs[toolObj].diffuse += mat[1];
}

static void adjustSpecularShine(vec2 mat) {
    sceneObjs[toolObj].specular += mat[0];
    sceneObjs[toolObj].shine += mat[1];
}
////////////////////////////////////////////////////////////////////////////
...
static void materialMenu(int id) {
	...
	//PART C
        ...
        toolObj = currObject;
        setToolCallbacks(adjustAmbient, mat2(1.0, 0, 0, 1.0),
